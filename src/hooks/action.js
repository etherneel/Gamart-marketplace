...
export const saleFunc = async (
  ...
  return new Promise(async (resolve, reject) => {
    ...
    await marketContract.putTokenOnSale(
      tokenID,
...
export const byNowFunc = async (
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const marketContract = getMargetContract(networkID, signer);
      try {
        await marketContract.buyNFTWithBNB(tokenID, address, {
...
export const setProfilePic = async (address, img, dispatch) => {
  return new Promise((resolve, reject) => {
    axios
      .post(`${SERVER_URL}/profilepic`, { address: address, picUrl: img })
      .then(async (res) => {
        const data = { res };
        if (data.success) {
...
export const getAccountDetails = async (address) => {
  return new Promise((resolve, reject) => {
    axios
      .post(`${SERVER_URL}/check`, { address: address })
      .then(async (res) => {
        const { data } = res.data;
...
export const creatProfile = async (
  address,
  username,
  description,
  instagram,
